...
public class Porto implements Serializable
{
	...
	/**
	 * Esporta i dati di una barca in un file csv.
	...
	/**
	 * Metodo che simula l'arrivo di una barca.
	 * @throws PortoException viene sollevato quando il porto è vuoto.
	 * @throws FileException viene sollevata quando ci sono errori sul file.
	 * @throws NumberFormatException viene sollevata quando il formato inserito non è corretto.
	 * @throws ClassNotFoundException viene sollevata quando ci sono errori di casting.
	 */
